...
<div class="container">
    <form action="{{ route('event.create') }}" method="POST">
        ...
        <div class="form-group w-25">
            ...
            <input type="text" class="form-control{{ $errors->has('entry_fee') ? ' is-invalid' : '' }}" name="entry_fee" id="entry_fee" value="{{ old('entry_fee') }}">
        ...
        <div class="form-group">
            ...
            <textarea class="form-control{{ $errors->has('contents') ? ' is-invalid' : '' }}" name="contents" id="contents" rows="10" placeholder="もくもく会の詳細を記載してください。">{{ old('contents') }}</textarea>
